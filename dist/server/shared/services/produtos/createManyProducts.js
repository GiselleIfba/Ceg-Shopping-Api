...
// src/server/shared/services/produtos/createManyProducts.ts
var createManyProducts_exports = {};
__export(createManyProducts_exports, {
  createManyProductsService: () => createManyProductsService
});
...
// src/server/shared/services/produtos/createManyProducts.ts
var createManyProductsService = (P, res) => __async(void 0, null, function* () {
  try {
    connect();
